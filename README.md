...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=mafruda14&label=Profile%20Views&color=6A0DAD&style=flat-square" alt="Profile Views" />
  <img src="https://img.shields.io/github/stars/mafruda14?label=Stars&style=flat-square&color=FFD700" alt="GitHub Stars" />
</p>
...
<p align="left">
  ...
  <a href="https://www.hackerrank.com/mafrudajaman">
...
`Arrays` • `Strings` • `Sorting` • `Searching` • `Greedy` • `Binary Search` • `Graphs` • `Trees` • `Dynamic Programming`
